  ...
  const TutorCard = ({ name, title, image, uniqueKey }: TutorCardProps) => {
    ...
    return (
      <div
        ...
        style={{
          boxShadow: isHovered
            ? "0 25px 50px -12px rgba(255, 137, 48, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.2)"
            : "0 10px 15px -3px rgba(0, 0, 0, 0.2), 0 4px 6px -4px rgba(0, 0, 0, 0.1)",
        }}>
        {/* Animated background gradient */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#ff8930]/10 via-[#4247cb]/10 to-[#ff8930]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        ...
        <div className="flex justify-between w-full mb-4 relative z-10">
          ...
          <div className="flex space-x-2">
            ...
            <span
              className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                isHovered ? "bg-[#ff8930] shadow-lg shadow-[#ff8930]/50" : "bg-white/30"
              }`}></span>
            <span
              className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                isHovered ? "bg-[#4247cb] shadow-lg shadow-[#4247cb]/50" : "bg-white/30"
              }`}></span>
          </div>
        </div>

        {/* Image container */}
        <div className="relative w-full flex-1 overflow-hidden rounded-2xl border-2 border-white/40 bg-gradient-to-b from-[#ff8930]/20 to-[#4247cb]/20 shadow-2xl transition-all duration-500">
          {/* Background gradient overlay */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#ff8930]/20 via-[#4247cb]/10 to-transparent opacity-100 transition-opacity duration-700" />
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-20 right-20 w-32 h-32 rounded-full bg-gradient-to-br from-[#ff8930]/10 to-[#4247cb]/10 blur-xl"
        />
        <motion.div
          animate={{
            rotate: -360,
          ...
          className="absolute bottom-40 left-10 w-24 h-24 rounded-full bg-gradient-to-br from-[#4247cb]/10 to-[#ff8930]/10 blur-xl"
        />
      </div>
      ...
      <div className="min-h-screen py-16 xl:py-0 grid gap-8 xl:gap-0 relative z-10 max-w-screen-xl w-full mx-auto xl:grid-cols-2 px-6 md:px-8">
        <div className="self-center space-y-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-gradient-to-r from-[#ff8930]/20 to-[#4247cb]/20 backdrop-blur-md border border-[#ff8930]/30 shadow-lg shadow-[#ff8930]/10">
            <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ duration: 2, repeat: Infinity }}>
              <Sparkles className="w-4 h-4 text-[#ff8930]" />
            </motion.div>
            <span className="text-sm font-bold text-white">Premium Tutoring Experience</span>
            <div className="w-2 h-2 rounded-full bg-[#ff8930] animate-pulse" />
          </motion.div>
          ...
          <motion.div
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                size="lg"
                className="text-base font-bold py-7 px-8 gap-3 bg-gradient-to-r from-[#ff8930] to-[#4247cb] hover:from-[#ff7520] hover:to-[#383db5] shadow-xl shadow-[#ff8930]/25 border-0">
                Explore Our Courses
