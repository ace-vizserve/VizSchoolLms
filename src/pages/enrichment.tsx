              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {["Primary One", "Primary Two", "Primary Three", "Primary Four", "Primary Five", "Primary Six"].map(
                      (course, index) => (
          ...
          <div className="text-center mt-16">
            <div className="bg-[#007AFF] rounded-2xl p-8 text-white">
              ...
              <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
                Join our community of learners and give your child the best educational foundation. Our admissions team
